...
export function ListingsProvider({ children }: { children: ReactNode }) {
  const [listings, setListings] = useState<LuggageListing[]>([
    ...
    },
    {
      ...
      description: 'Private basement storage with individual access. Clean, dry, and secure environment.',
      images: ['/placeholder.svg'],
      category: 'cell',
      type: 'hybrid',
    ...
    },
    {
      ...
      description: 'Huge warehouse space perfect for multiple luggage items or large storage needs.',
      images: ['/placeholder.svg'],
      category: 'large-space',
      type: 'hardside',
      size: { height: 400, width: 1000, depth: 800, unit: 'cm' },
      features: ['Forklift Access', 'Loading Dock', '24/7 Security', 'Climate Control'],
      condition: 'excellent',
      location: {
    ...
    },
    {
      ...
      description: 'Clean pantry space converted for storage. Temperature controlled and very secure.',
      images: ['/placeholder.svg'],
      category: 'pantry',
      type: 'softside',
      size: { height: 250, width: 150, depth: 200, unit: 'cm' },
      features: ['Temperature Control', 'Shelving Available', 'Private Key', 'Organized Space'],
      condition: 'good',
      location: {
