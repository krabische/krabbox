        ...
        <div className="container">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div>
              ...
              <div className="text-muted-foreground">Luggage Options</div>
            </div>
            <div>
              <div className="text-3xl md:text-4xl font-bold text-primary mb-2">
                4.9
        ...
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Join thousands of smart travelers who save money and hassle by
              renting luggage instead of buying or dragging it everywhere.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <p className="text-muted-foreground">
                Every rental is fully insured up to $1,000. Travel with
                confidence knowing your belongings are protected.
              </p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <p className="text-muted-foreground">
                Book instantly with most hosts responding within minutes.
            ...
            <div className="text-center p-6">
              ...
              <p className="text-muted-foreground">
                Join a community of verified hosts and travelers. Read reviews
                and ratings before you book.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-r from-primary to-purple-600 text-white">
        <div className="container text-center">
          ...
          <p className="text-xl mb-8 text-white/90 max-w-2xl mx-auto">
            Join thousands of travelers who save money and hassle with LugSpace.
            Find your perfect luggage rental today.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              size="lg"
            ...
            <Button
              size="lg"
              variant="outline"
              className="text-lg px-8 py-3 h-auto border-primary text-primary bg-white hover:bg-primary hover:text-white"
            >
              List Your Luggage
            </Button>
          </div>
