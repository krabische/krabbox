        ...
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Join thousands of smart travelers who save money and hassle by renting luggage instead of buying or dragging it everywhere.
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-primary to-purple-600 text-white">
        <div className="container text-center">
          ...
          <p className="text-xl mb-8 text-white/90 max-w-2xl mx-auto">
            Join thousands of travelers who save money and hassle with LugSpace. Find your perfect luggage rental today.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
