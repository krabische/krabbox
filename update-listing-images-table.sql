-- Ensure listing_images table has expected columns
...
ALTER TABLE listing_images ADD COLUMN IF NOT EXISTS order_index INTEGER DEFAULT 0;
ALTER TABLE listing_images ADD COLUMN IF NOT EXISTS updated_at TIMESTAMPTZ DEFAULT NOW();
